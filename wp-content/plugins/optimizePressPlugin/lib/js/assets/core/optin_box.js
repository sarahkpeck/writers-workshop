                        ...
                        form_html: {
                            ...
                            fields: {
                                ...
                                signup_form_id: {
                                    ...
                                    type: 'input',
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['emma']},
                                    default_value: ''
                                },
                                thank_you_page: {
                                ...
                                email_2: {
                                    ...
                                    showOn: {field:'step_2.tabs.tabs.form_html.fields.integration_type',value:['email', 'aweber', 'infusionsoft', 'icontact', 'mailchimp', 'emma', 'getresponse', 'campaignmonitor', 'officeautopilot', 'ontraport']}
                                },
                                method: {
                                    title: 'method',
                                    type: 'select',
        ...
        customSettings: function(attrs,steps){
            ...
            switch (attrs.integration_type) {
                ...
                case 'emma':
                    ...
                    vals = {'email_order': ['email_order', 0], 'name_order': ['name_order', 0], 'integration_type': ['integration_type', 'custom'], 'name':['name_field', ''], 'list': ['list', ''], 'gotowebinar_list': ['gotowebinar', ''], 'thank_you_page': ['thank_you_page', ''], 'signup_form_id': ['signup_form_id', '']};
                    break;
            }
