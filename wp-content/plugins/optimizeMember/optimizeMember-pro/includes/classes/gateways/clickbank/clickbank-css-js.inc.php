...
if (!class_exists ("c_ws_plugin__optimizemember_pro_clickbank_css_js"))
	{
		/**
		* ClickBank® CSS/JS for theme integration.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_clickbank_css_js
			{
				/**
				...
				public static function clickbank_css ($vars = FALSE)
					{
						...
						if (!apply_filters ("ws_plugin__optimizemember_pro_css_affects_gateways", true) // Does it affect this?
						|| has_action ("ws_plugin__optimizemember_during_css", "c_ws_plugin__optimizemember_pro_css_js::css")) // Only if CSS loads.
				...
				*/
				public static function clickbank_js_w_globals ($vars = FALSE)
					{
						$g = "var OPTIMIZEMEMBER_PRO_CLICKBANK_GATEWAY = true,";
