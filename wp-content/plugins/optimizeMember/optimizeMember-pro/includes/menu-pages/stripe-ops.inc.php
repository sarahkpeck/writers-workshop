...
if(!class_exists('c_ws_plugin__optimizemember_pro_menu_page_stripe_ops'))
{
	...
	class c_ws_plugin__optimizemember_pro_menu_page_stripe_ops
	{
		public function __construct()
		{
			...
			echo '<em>Only enable this if you\'ve provided test credentials above. This puts OptimizeMember\'s Stripe integration into Sandbox/Test mode. See: <a href="http://www.optimizemember.com/r/stripe-test-accounts/" target="_blank" rel="external">Stripe Test Accounts</a></em>'."\n";
			echo '</td>'."\n";
