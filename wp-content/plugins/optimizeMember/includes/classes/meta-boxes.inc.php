...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_meta_boxes"))
	{
		/**
		* Administrative Meta Boxes.
		*
		...
		* @since 3.5
		*/
		class c_ws_plugin__optimizemember_meta_boxes
			{
				/**
				...
				*/
				public static function add_meta_boxes ($type = FALSE)
					{
						do_action ("ws_plugin__optimizemember_before_add_meta_boxes", get_defined_vars ());
						/**/
						$excluded_types = array ("link", "comment", "revision", "attachment", "nav_menu_item");
						$excluded_types = apply_filters ("ws_plugin__optimizemember_add_meta_boxes_excluded_types", $excluded_types, get_defined_vars ());
						/**/
						if (in_array ($type, array_keys (get_post_types ())) && !in_array ($type, $excluded_types))
							add_meta_box ("ws-plugin--optimizemember-security", "OptimizeMember", "c_ws_plugin__optimizemember_meta_box_security::security_meta_box", $type, "side", "high");
						/**/
						do_action ("ws_plugin__optimizemember_after_add_meta_boxes", get_defined_vars ());
						/**/
