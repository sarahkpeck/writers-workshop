...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_authnet_sp_checkout"))
	{
		/**
		* Authorize.Net Specific Post/Page Check form processing.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_authnet_sp_checkout
			{
				/**
				...
				*/
				public static function authnet_sp_checkout ()
					{
						if (!empty ($_POST["optimizemember_pro_authnet_sp_checkout"])) /* Call inner routine? */
							{
								return c_ws_plugin__optimizemember_pro_authnet_sp_checkout_in::authnet_sp_checkout ();
							}
					}
			}
	}
