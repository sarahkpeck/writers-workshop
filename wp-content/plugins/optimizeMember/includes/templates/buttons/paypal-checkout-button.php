...
<form action="https://%%endpoint%%/cgi-bin/webscr" method="post">
 ...
 <!-- <?php echo _x ("Configures optimizeMember's Unique Invoice ID/Code", "s2member-admin", "s2member"); ?>  -->
 <input type="hidden" name="invoice" value="<?php echo "<?php echo OPTIMIZEMEMBER_VALUE_FOR_PP_INV(); ?>"; ?>" />
 <!-- <?php echo _x ("Identifies/Updates An Existing User/Member ( when/if applicable )", "s2member-admin", "s2member"); ?>  -->
 <input type="hidden" name="on0" value="<?php echo "<?php echo OPTIMIZEMEMBER_CURRENT_USER_VALUE_FOR_PP_ON0; ?>"; ?>" />
 <input type="hidden" name="os0" value="<?php echo "<?php echo OPTIMIZEMEMBER_CURRENT_USER_VALUE_FOR_PP_OS0; ?>"; ?>" />
 <!-- <?php echo _x ("Identifies The Customer's IP Address For Tracking", "s2member-admin", "s2member"); ?> -->
 <input type="hidden" name="on1" value="<?php echo "<?php echo OPTIMIZEMEMBER_CURRENT_USER_VALUE_FOR_PP_ON1; ?>"; ?>" />
 <input type="hidden" name="os1" value="<?php echo "<?php echo OPTIMIZEMEMBER_CURRENT_USER_VALUE_FOR_PP_OS1; ?>"; ?>" />
