...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_paypal_sp_checkout"))
	{
		/**
		* PayPal Specific Post/Page Check form processing.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_paypal_sp_checkout
			{
				/**
				...
				*/
				public static function paypal_sp_checkout ()
					{
						if (!empty ($_POST["optimizemember_pro_paypal_sp_checkout"]) || (!empty ($_GET["optimizemember_paypal_xco"]) && $_GET["optimizemember_paypal_xco"] === "optimizemember_pro_paypal_sp_checkout_return"))
							{
								return c_ws_plugin__optimizemember_pro_paypal_sp_checkout_in::sp_checkout ();
							}
					}
			}
	}
