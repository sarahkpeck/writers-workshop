...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_authnet_notify"))
	{
		/**
		* Authorize.Net Silent Post *( aka: IPN )* handler.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_authnet_notify
			{
				/**
				...
				*/
				public static function authnet_notify ()
					{
						if (!empty ($_GET["optimizemember_pro_authnet_notify"])) /* Call inner routine? */
							{
								return c_ws_plugin__optimizemember_pro_authnet_notify_in::authnet_notify ();
							}
					}
			}
	}
