...
if (!class_exists ("c_ws_plugin__optimizemember_pro_clickbank_constants"))
	{
		/**
		* ClickBank® API Constants *(for site owners)*.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_clickbank_constants
			{
				/**
				* ClickBank® API Constants *(for site owners)*.
				*
				...
				public static function clickbank_constants ($c = FALSE, $vars = FALSE)
					{
						...
						* @var bool
						*/
						if (!defined ("OPTIMIZEMEMBER_PRO_CLICKBANK_GATEWAY"))
							define ("OPTIMIZEMEMBER_PRO_CLICKBANK_GATEWAY", ($c[] = true));
