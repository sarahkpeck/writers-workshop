...
/**/
else if (in_array ($o_ws_plugin__plugins_s2member, wp_get_active_network_plugins ()) && file_exists ($o_ws_plugin__plugins_s2member) && !$o_ws_plugin__optimizemember_is_loaded_already)
