...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_ccbill_notify"))
	{
		/**
		* ccBill IPN Handler.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_ccbill_notify
			{
				/**
				...
				*/
				public static function ccbill_notify ()
					{
						if (isset ($_GET["optimizemember_pro_ccbill_notify"]) && strlen ($_GET["optimizemember_pro_ccbill_notify"])) /* Call inner routine? */
							{
								return c_ws_plugin__optimizemember_pro_ccbill_notify_in::ccbill_notify ();
							}
					}
			}
	}
