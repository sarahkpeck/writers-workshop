...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_utils_html"))
	{
		/**
		* HTML utilities.
		*
		...
		* @since 110720
		*/
		class c_ws_plugin__optimizemember_utils_html
			{
				/**
				...
				*/
				public static function doctype_html_head ($doctype_html_head_title = FALSE, $doctype_html_head_action = FALSE)
					{
						$s2o = $GLOBALS["WS_PLUGIN__"]["optimizemember"]["c"]["s2o_url"]; /* Loads optimizeMember only. */
						/**/
