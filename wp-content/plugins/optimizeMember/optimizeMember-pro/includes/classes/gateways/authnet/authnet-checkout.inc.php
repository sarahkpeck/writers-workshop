...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_authnet_checkout"))
	{
		/**
		* Authorize.Net Checkout Form handler.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_authnet_checkout
			{
				/**
				...
				*/
				public static function authnet_checkout ()
					{
						if (!empty ($_POST["optimizemember_pro_authnet_checkout"])) /* Call inner routine? */
							{
								return c_ws_plugin__optimizemember_pro_authnet_checkout_in::authnet_checkout ();
							}
					}
			}
	}
