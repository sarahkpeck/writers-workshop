...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_paypal_form"))
	{
		/**
		* Shortcode `[optimizeMember-Pro-PayPal-Form /]`.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_paypal_form
			{
				/**
				* Shortcode `[optimizeMember-Pro-PayPal-Form /]`.
				*
				...
				*/
				public static function sc_paypal_form ($attr = FALSE, $content = FALSE, $shortcode = FALSE)
					{
						return c_ws_plugin__optimizemember_pro_paypal_form_in::sc_paypal_form ($attr, $content, $shortcode);
					}
			}
	}
?>