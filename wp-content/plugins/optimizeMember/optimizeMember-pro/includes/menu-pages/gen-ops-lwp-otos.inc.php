...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_menu_page_gen_ops_lwp_otos"))
	{
		/**
		* Menu page for optimizeMember Pro ( Login Welcome Page / One-Time-Offers ).
		*
		...
		* @since 110720
		*/
		class c_ws_plugin__optimizemember_pro_menu_page_gen_ops_lwp_otos
			{
...
/**/
new c_ws_plugin__optimizemember_pro_menu_page_gen_ops_lwp_otos ();
?>