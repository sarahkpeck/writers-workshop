...
* {@link optimizeMember\Utilities\c_ws_plugin__optimizemember_utils_urls::remote()}
*
...
class NC_MCAPI {
    ...
    */
    ...
    function callServer($method, $params) {
        ...
        if (!is_array ($_response = c_ws_plugin__optimizemember_utils_urls::remote ($s2_url, $post_vars, $s2_ags, "array"))){
