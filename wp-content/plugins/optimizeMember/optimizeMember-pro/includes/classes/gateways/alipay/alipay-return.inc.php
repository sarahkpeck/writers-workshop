...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_alipay_return"))
	{
		/**
		* AliPay Return URL handler.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_alipay_return
			{
				/**
				...
				*/
				public static function alipay_return ()
					{
						if (!empty ($_GET["optimizemember_pro_alipay_return"])) /* Call inner routine? */
							{
								return c_ws_plugin__optimizemember_pro_alipay_return_in::alipay_return ();
							}
					}
			}
	}
