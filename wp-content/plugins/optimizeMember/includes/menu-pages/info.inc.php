<?php
/**
* Menu page for the optimizeMember plugin ( optimizeMember Info page ).
*
* Copyright: © 2009-2011
...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_menu_page_info"))
	{
		/**
		* Menu page for the optimizeMember plugin ( optimizeMember Info page ).
		*
		...
		* @since 110531
		*/
		class c_ws_plugin__optimizemember_menu_page_info
			{
...
/**/
new c_ws_plugin__optimizemember_menu_page_info ();
?>