...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_authnet_cancellation"))
	{
		/**
		* Authorize.Net Cancellation Form handler.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_authnet_cancellation
			{
				/**
				...
				*/
				public static function authnet_cancellation ()
					{
						if (!empty ($_POST["optimizemember_pro_authnet_cancellation"])) /* Call inner rountine? */
							{
								return c_ws_plugin__optimizemember_pro_authnet_cancellation_in::authnet_cancellation ();
							}
					}
			}
	}
