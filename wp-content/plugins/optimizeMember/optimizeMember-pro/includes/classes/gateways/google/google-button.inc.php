...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_google_button"))
	{
		/**
		* Shortcode `[optimizeMember-Pro-Google-Button /]`.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_google_button
			{
				/**
				* Shortcode `[optimizeMember-Pro-Google-Button /]`.
				*
				...
				*/
				public static function sc_google_button ($attr = FALSE, $content = FALSE, $shortcode = FALSE)
					{
						return c_ws_plugin__optimizemember_pro_google_button_in::sc_google_button ($attr, $content, $shortcode);
					}
			}
	}
?>