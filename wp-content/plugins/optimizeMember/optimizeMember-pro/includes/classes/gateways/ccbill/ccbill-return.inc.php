...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_ccbill_return"))
	{
		/**
		* ccBill Return URL handler.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_ccbill_return
			{
				/**
				...
				*/
				public static function ccbill_return ()
					{
						if (!empty ($_GET["optimizemember_pro_ccbill_return"])) /* Call inner routine? */
							{
								return c_ws_plugin__optimizemember_pro_ccbill_return_in::ccbill_return ();
							}
					}
			}
	}
