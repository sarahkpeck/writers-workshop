						...
						for ($n = 1; $n <= $GLOBALS["WS_PLUGIN__"]["optimizemember"]["c"]["levels"]; $n++)
							{
								...
								$ws_plugin__optimizemember_pro_temp_s = preg_replace ("/%%item%%/", c_ws_plugin__optimizemember_utils_strings::esc_ds (esc_attr ("0")), $ws_plugin__optimizemember_pro_temp_s);
