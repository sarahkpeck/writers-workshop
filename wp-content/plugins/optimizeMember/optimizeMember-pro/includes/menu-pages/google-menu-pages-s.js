...
jQuery(document).ready (function($)
	{
		...
		/**/
		if (location.href.match (/page\=ws-plugin--optimizemember-pro-google-ops/))
			{
		...
		/**/
		else if (location.href.match (/page\=ws-plugin--optimizemember-pro-google-buttons/))
			{
				...
				/**/
				ws_plugin__optimizemember_pro_googleButtonGenerate = /* Handles Google Button Generation. */ function(button)
					{
						var shortCodeTemplate = '[optimizeMember-Pro-Google-Button %%attrs%% image="default" output="anchor" /]', shortCodeTemplateAttrs = '', labels = {};
						/**/
						...
						var regRecur = $('select#ws-plugin--optimizemember-pro-' + button + '-term').val ().split ('-')[2].replace (/[^0-1BN]/g, '');
						/**/
				...
				/**/
				ws_plugin__optimizemember_pro_googleCcapButtonGenerate = /* Handles Google Button Generation. */ function()
					{
						var shortCodeTemplate = '[optimizeMember-Pro-Google-Button %%attrs%% image="default" output="anchor" /]', shortCodeTemplateAttrs = '';
						/**/
				...
				/**/
				ws_plugin__optimizemember_pro_googleSpButtonGenerate = /* Handles Google Button Generation for Specific Post/Page Access. */ function()
					{
						var shortCodeTemplate = '[optimizeMember-Pro-Google-Button %%attrs%% image="default" output="button" /]', shortCodeTemplateAttrs = '';
						/**/
				...
				/**/
				ws_plugin__optimizemember_pro_googleRegLinkGenerate = /* Handles Google Link Generation. */ function()
					{
				...
				/**/
				ws_plugin__optimizemember_pro_googleSpLinkGenerate = /* Handles Google Link Generation. */ function()
					{
