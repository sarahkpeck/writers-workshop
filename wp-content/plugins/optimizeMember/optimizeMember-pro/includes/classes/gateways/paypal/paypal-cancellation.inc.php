...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_paypal_cancellation"))
	{
		/**
		* PayPal Cancellation Form processing.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_paypal_cancellation
			{
				/**
				...
				*/
				public static function paypal_cancellation ()
					{
						if (!empty ($_POST["optimizemember_pro_paypal_cancellation"])) /* Call inner routine? */
							{
								if($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["paypal_payflow_api_username"])
									return c_ws_plugin__optimizemember_pro_paypal_cancellation_pf_in::paypal_cancellation();
								/**/
								return c_ws_plugin__optimizemember_pro_paypal_cancellation_in::paypal_cancellation ();
							}
					}
			}
	}
