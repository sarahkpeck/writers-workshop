...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_ccbill_css_js"))
	{
		/**
		* ccBill CSS/JS for theme integration.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_ccbill_css_js
			{
				/**
				...
				*/
				public static function ccbill_js_w_globals ($vars = FALSE)
					{
						$g = "var OPTIMIZEMEMBER_PRO_CCBILL_GATEWAY = true,";
						/**/
