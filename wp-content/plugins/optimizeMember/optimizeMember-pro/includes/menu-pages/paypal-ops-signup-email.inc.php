<?php
/**
* Menu page for optimizeMember Pro ( PayPal options, Signup Email ).
*
* Copyright: © 2009-2011
...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_menu_page_paypal_ops_signup_email"))
	{
		/**
		* Menu page for optimizeMember Pro ( PayPal options, Signup Email ).
		*
		...
		* @since 110531
		*/
		class c_ws_plugin__optimizemember_pro_menu_page_paypal_ops_signup_email
			{
...
/**/
new c_ws_plugin__optimizemember_pro_menu_page_paypal_ops_signup_email ();
?>