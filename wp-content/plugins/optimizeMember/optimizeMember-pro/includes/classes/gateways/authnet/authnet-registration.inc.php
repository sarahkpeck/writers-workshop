...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_authnet_registration"))
	{
		/**
		* Authorize.Net Registration Form processing.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_authnet_registration
			{
				/**
				...
				*/
				public static function authnet_registration ()
					{
						if (!empty ($_POST["optimizemember_pro_authnet_registration"])) /* Call inner routine? */
							{
								return c_ws_plugin__optimizemember_pro_authnet_registration_in::authnet_registration ();
							}
					}
			}
	}
