...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_option_forces"))
	{
		/**
		* Forces WordPress options.
		*
		...
		* @since 3.5
		*/
		class c_ws_plugin__optimizemember_option_forces
			{
				/**
				...
				* @return str Default Role, as configured by optimizeMember.
				*/
				public static function force_default_role ($default_role = FALSE)
					{
						do_action ("ws_plugin__optimizemember_before_force_default_role", get_defined_vars ());
						/**/
						return apply_filters ("ws_plugin__optimizemember_force_default_role", ($default_role = "subscriber"), get_defined_vars ());
					}
				/**
				...
				*/
				public static function force_mms_default_role ($default_role = FALSE)
					{
						do_action ("ws_plugin__optimizemember_before_force_mms_default_role", get_defined_vars ());
						/**/
						return apply_filters ("ws_plugin__optimizemember_force_mms_default_role", ($default_role = "subscriber"), get_defined_vars ());
					}
				/**
				...
				* @return str Demotion Role, as configured by optimizeMember.
				*/
				public static function force_demotion_role ($demotion_role = FALSE)
					{
						do_action ("ws_plugin__optimizemember_before_force_demotion_role", get_defined_vars ());
						/**/
						return apply_filters ("ws_plugin__optimizemember_force_demotion_role", ($demotion_role = "subscriber"), get_defined_vars ());
					}
				/**
				...
				*/
				public static function mms_allow_new_users ($allow = FALSE)
					{
						do_action ("ws_plugin__optimizemember_before_mms_allow_new_users", get_defined_vars ());
						/**/
						return apply_filters ("ws_plugin__optimizemember_mms_allow_new_users", ($allow = "1"), get_defined_vars ());
					}
				/**
				...
				* @return int|str Numeric Dashboard Blog ID, as configured by optimizeMember. Forces to the Main Site.
				*/
				public static function mms_dashboard_blog ($dashboard_blog = FALSE)
					{
						global $current_site, $current_blog; /* For Multisite support. */
						/**/
						do_action ("ws_plugin__optimizemember_before_mms_dashboard_blog", get_defined_vars ());
						/**/
						$main_site = ((is_multisite ()) ? $current_site->blog_id : "1"); /* Forces the Main Site. */
						/**/
						return apply_filters ("ws_plugin__optimizemember_mms_dashboard_blog", ($dashboard_blog = $main_site), get_defined_vars ());
					}
				/**
				...
				public static function check_register_access ($users_can_register = FALSE)
					{
						...
						/**/
						$by_default = $users_can_register = $GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["allow_subscribers_in"];
						/**/
						if (is_multisite () && c_ws_plugin__optimizemember_utils_conds::is_multisite_farm () && is_main_site ())
							return apply_filters ("ws_plugin__optimizemember_check_register_access", ($users_can_register = "0"), get_defined_vars ());
						/**/
						else if (!is_admin () && !$users_can_register) /* Do NOT run these security checks on option pages; it's confusing. */
							if (!is_multisite () || !c_ws_plugin__optimizemember_utils_conds::is_multisite_farm () || !is_main_site () || current_user_can ("create_users") || is_super_admin ())
								{
									if (current_user_can ("create_users") || (is_multisite () && is_super_admin ()) || c_ws_plugin__optimizemember_register_access::reg_cookies_ok ())
										{
											return apply_filters ("ws_plugin__optimizemember_check_register_access", ($users_can_register = "1"), get_defined_vars ());
										}
								}
						/**/
						return apply_filters ("ws_plugin__optimizemember_check_register_access", $users_can_register, get_defined_vars ());
					}
				/**
				...
				public static function check_mms_register_access ($users_can_register = FALSE)
					{
						...
						/**/
						if (c_ws_plugin__optimizemember_utils_conds::bp_is_installed () && is_multisite () && /* BP Multisite / but NOT offering Blogs? */ !c_ws_plugin__optimizemember_utils_conds::is_multisite_farm ())
						...
						/**/
						else if (!is_multisite () || !c_ws_plugin__optimizemember_utils_conds::is_multisite_farm ()) /* Blog Farm? */
						...
						/**/
						else if (!is_network_admin () && $users_can_register !== "all") /* Do NOT run these checks on Network option pages; it's confusing. */
							{
								...
								/**/
								else if (is_user_logged_in () && is_object ($user = wp_get_current_user ()) && $user->ID && is_object ($user = new WP_User ($user->ID, $current_site->blog_id)) && $user->ID && $user->has_cap ("access_optimizemember_level1"))
									{
								...
								else if (!is_user_logged_in () && is_main_site () && ($reg_cookies = c_ws_plugin__optimizemember_register_access::reg_cookies_ok ()) && extract ($reg_cookies))
									{
				...
				public static function check_bp_mms_register_access ($site_options = FALSE)
					{
						if (is_multisite ()) /* Only if Multisite Networking is enabled. Pointless otherwise. */
							$site_options["registration"] = c_ws_plugin__optimizemember_option_forces::check_mms_register_access ($site_options["registration"]);
						/**/
						return apply_filters ("ws_plugin__optimizemember_check_bp_mms_register_access", $site_options, get_defined_vars ());
					}
			}
	}
?>