...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_alipay_menu_pages"))
	{
		/**
		* AliPay Menu Pages.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_alipay_menu_pages
			{
				/**
				...
				public static function alipay_admin_options ($add_divider = TRUE, $vars = FALSE)
					{
						...
						add_submenu_page ($vars["menu"], "optimizeMember Pro / AliPay Options", "AliPay Options", "create_users", "ws-plugin--optimizemember-pro-alipay-ops", "c_ws_plugin__optimizemember_pro_alipay_menu_pages::alipay_ops_page");
						add_submenu_page ($vars["menu"], "optimizeMember Pro / AliPay Buttons", "AliPay Buttons", "create_users", "ws-plugin--optimizemember-pro-alipay-buttons", "c_ws_plugin__optimizemember_pro_alipay_menu_pages::alipay_buttons_page");
						/**/
