...
if (!class_exists ("c_ws_plugin__optimizemember_pro_clickbank_return"))
	{
		/**
		* ClickBank® Return URL handler.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_clickbank_return
			{
				/**
				...
				*/
				public static function clickbank_return ()
					{
						if (!empty ($_GET["optimizemember_pro_clickbank_return"]))
							{
								return c_ws_plugin__optimizemember_pro_clickbank_return_in::clickbank_return ();
							}
					}
			}
	}
