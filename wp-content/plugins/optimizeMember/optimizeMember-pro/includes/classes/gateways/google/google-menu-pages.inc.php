...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_google_menu_pages"))
	{
		/**
		* Google Menu Pages.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_google_menu_pages
			{
				/**
				...
				public static function google_admin_options ($add_divider = TRUE, $vars = FALSE)
					{
						...
						add_submenu_page ($vars["menu"], "optimizeMember Pro / Google Options", "Google Options", "create_users", "ws-plugin--optimizemember-pro-google-ops", "c_ws_plugin__optimizemember_pro_google_menu_pages::google_ops_page");
						add_submenu_page ($vars["menu"], "optimizeMember Pro / Google Buttons", "Google Buttons", "create_users", "ws-plugin--optimizemember-pro-google-buttons", "c_ws_plugin__optimizemember_pro_google_menu_pages::google_buttons_page");
						/**/
