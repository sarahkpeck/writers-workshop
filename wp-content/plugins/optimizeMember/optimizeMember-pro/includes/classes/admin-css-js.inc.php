...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_admin_css_js"))
	{
		/**
		* Administrative CSS/JS.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_admin_css_js
			{
				/**
				* Adds JavaScript for optimizeMember Pro menu pages.
				*
				* @package optimizeMember\Admin_CSS_JS
				* @since 1.5
				*
