...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_authnet_update"))
	{
		/**
		* Authorize.Net Update Form processing.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_authnet_update
			{
				/**
				...
				*/
				public static function authnet_update ()
					{
						if (!empty ($_POST["optimizemember_pro_authnet_update"])) /* Call inner routine? */
							{
								return c_ws_plugin__optimizemember_pro_authnet_update_in::authnet_update ();
							}
					}
			}
	}
