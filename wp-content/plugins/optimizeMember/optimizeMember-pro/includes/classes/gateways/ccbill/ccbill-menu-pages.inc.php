...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_ccbill_menu_pages"))
	{
		/**
		* ccBill Menu Pages.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_ccbill_menu_pages
			{
				/**
				...
				public static function ccbill_admin_options ($add_divider = TRUE, $vars = FALSE)
					{
						...
						add_submenu_page ($vars["menu"], "optimizeMember Pro / ccBill Options", "ccBill Options", "create_users", "ws-plugin--optimizemember-pro-ccbill-ops", "c_ws_plugin__optimizemember_pro_ccbill_menu_pages::ccbill_ops_page");
						add_submenu_page ($vars["menu"], "optimizeMember Pro / ccBill Buttons", "ccBill Buttons", "create_users", "ws-plugin--optimizemember-pro-ccbill-buttons", "c_ws_plugin__optimizemember_pro_ccbill_menu_pages::ccbill_buttons_page");
						/**/
