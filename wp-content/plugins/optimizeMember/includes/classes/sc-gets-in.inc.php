<?php
/**
* Shortcode `[opmGet /]` ( inner processing routines ).
*
* Copyright: © 2009-2011
...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_sc_gets_in"))
	{
		/**
		* Shortcode `[opmGet /]` ( inner processing routines ).
		*
		...
		* @since 3.5
		*/
		class c_ws_plugin__optimizemember_sc_gets_in
			{
				/**
				...
				public static function sc_get_details ($attr = FALSE, $content = FALSE, $shortcode = FALSE)
					{
						...
						unset ($__refs, $__v); /* Unset defined __refs, __v. */
						/**/
						if ($attr["constant"] && defined ($attr["constant"])) /* Security check here. It must start with OPTIMIZEMEMBER_ on a Blog Farm. */
							{
