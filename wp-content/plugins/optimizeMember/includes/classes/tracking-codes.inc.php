...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_tracking_codes"))
	{
		/**
		* Tracking Codes.
		*
		...
		* @since 3.5
		*/
		class c_ws_plugin__optimizemember_tracking_codes
			{
				/**
				...
				* optimizeMember will display Tracking Codes in (1) of these 4 locations:
				*
				...
				*/
				public static function display_signup_tracking_codes ()
					{
						do_action ("ws_plugin__optimizemember_before_display_signup_tracking_codes", get_defined_vars ());
						/**/
						if ((!empty ($_COOKIE["optimizemember_tracking"]) && ($subscr_or_txn_id = c_ws_plugin__optimizemember_utils_encryption::decrypt ($_COOKIE["optimizemember_tracking"]))) || (($reg_cookies = c_ws_plugin__optimizemember_register_access::reg_cookies_ok ()) && extract ($reg_cookies) && ($subscr_or_txn_id = $subscr_id)))
							{
								if (($code = get_transient ($transient = "s2m_" . md5 ("optimizemember_transient_signup_tracking_codes_" . $subscr_or_txn_id))))
									{
										...
										do_action ("ws_plugin__optimizemember_during_display_signup_tracking_codes", get_defined_vars ());
						...
						/**/
						do_action ("ws_plugin__optimizemember_after_display_signup_tracking_codes", get_defined_vars ());
						/**/
				...
				*/
				public static function display_modification_tracking_codes ()
					{
						do_action ("ws_plugin__optimizemember_before_display_modification_tracking_codes", get_defined_vars ());
						/**/
						if ((!empty ($_COOKIE["optimizemember_tracking"]) && ($subscr_or_txn_id = c_ws_plugin__optimizemember_utils_encryption::decrypt ($_COOKIE["optimizemember_tracking"]))) || (($reg_cookies = c_ws_plugin__optimizemember_register_access::reg_cookies_ok ()) && extract ($reg_cookies) && ($subscr_or_txn_id = $subscr_id)))
							{
								if (($code = get_transient ($transient = "s2m_" . md5 ("optimizemember_transient_modification_tracking_codes_" . $subscr_or_txn_id))))
									{
										delete_transient($transient); /* Only display this ONE time. Delete transient immediately. */
										/**/
										echo '<img src="' . esc_attr (site_url ("/?optimizemember_delete_tracking_cookie=1")) . '" alt="." style="width:1px; height:1px; border:0;" />' . "\n";
										/**/
										eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
										do_action ("ws_plugin__optimizemember_during_display_modification_tracking_codes", get_defined_vars ());
										unset ($__refs, $__v); /* Unset defined __refs, __v. */
										/**/
										if (is_multisite () && c_ws_plugin__optimizemember_utils_conds::is_multisite_farm () && !is_main_site ())
											{
						...
						/**/
						do_action ("ws_plugin__optimizemember_after_display_modification_tracking_codes", get_defined_vars ());
						/**/
						return; /* Return for uniformity. */
					}
				/**
				...
				*
				* These are stored inside optimizeMember's Transient Queue, by BOTH the IPN & Return-Data processors.
				*
				* Specific Post/Page Tracking Codes are only displayed/processed one time.
				* optimizeMember will display Tracking Codes in the footer of your theme.
				*
				* @package optimizeMember\Tracking
				* @since 3.5
				*
				...
				*/
				public static function display_sp_tracking_codes ()
					{
						do_action ("ws_plugin__optimizemember_before_display_sp_tracking_codes", get_defined_vars ());
						/**/
						if (!empty ($_COOKIE["optimizemember_sp_tracking"]) && ($txn_id = c_ws_plugin__optimizemember_utils_encryption::decrypt ($_COOKIE["optimizemember_sp_tracking"])))
							{
								if (($code = get_transient ($transient = "s2m_" . md5 ("optimizemember_transient_sp_tracking_codes_" . $txn_id))))
									{
										delete_transient($transient); /* Only display this ONE time. Delete transient immediately. */
										/**/
										echo '<img src="' . esc_attr (site_url ("/?optimizemember_delete_sp_tracking_cookie=1")) . '" alt="." style="width:1px; height:1px; border:0;" />' . "\n";
										/**/
										eval('foreach(array_keys(get_defined_vars())as$__v)$__refs[$__v]=&$$__v;');
										do_action ("ws_plugin__optimizemember_during_display_sp_tracking_codes", get_defined_vars ());
										unset ($__refs, $__v); /* Unset defined __refs, __v. */
										/**/
										if (is_multisite () && c_ws_plugin__optimizemember_utils_conds::is_multisite_farm () && !is_main_site ())
											{
						...
						/**/
						do_action ("ws_plugin__optimizemember_after_display_sp_tracking_codes", get_defined_vars ());
						/**/
						return; /* Return for uniformity. */
					}
				/**
				* Generates/returns all Tracking Codes integrated with optimizeMember.
				*
				* This method may be used in areas where optimizeMember needs to build tracking codes in a more dynamic way.
				*
				* @package optimizeMember\Tracking
				* @since 110720
				*
				* @return str HTML output for all Tracking Codes integrated with optimizeMember.
				*/
				public static function generate_all_tracking_codes ()
					{
						ob_start /* Begin output buffering so we can "return". */ ();
						/**/
						c_ws_plugin__optimizemember_tracking_codes::display_signup_tracking_codes ();
						c_ws_plugin__optimizemember_tracking_codes::display_modification_tracking_codes ();
						c_ws_plugin__optimizemember_tracking_codes::display_ccap_tracking_codes ();
						c_ws_plugin__optimizemember_tracking_codes::display_sp_tracking_codes ();
						/**/
						return apply_filters ("ws_plugin__optimizemember_generate_all_tracking_codes", ob_get_clean (), get_defined_vars ());
					}
			}
	}
?>