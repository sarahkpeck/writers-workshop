<?php
/**
* Menu page for optimizeMember Pro ( PayPal options, Sandbox tip ).
*
* Copyright: © 2009-2011
...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_menu_page_paypal_ops_sandbox_tip"))
	{
		/**
		* Menu page for optimizeMember Pro ( PayPal options, Sandbox tip ).
		*
