...
<div class="op-signup_form-form_html<?php echo $signup_form_additional_class; ?>">
    ...
    <p class="cf field-welcome-email">
        ...
        <label for="<?php echo $id ?>welcome_email"><?php _e('Welcome Email',OP_SN) ?></label>
    </p>

    <div class="field-signup-form-id cf">
        <label for="<?php echo $id ?>signup_form_id"><?php _e('Signup ID',OP_SN) ?>:</label>
    ...
    <div class="form_html_field form_html_info_field cf">
        <p><?php _e('We automatically integrate with the email field from your Email Marketing Service. If you have created a web form for integration, please ensure it includes an email field.', OP_SN); ?></p>
    </div>
