...
if (!class_exists ("c_ws_plugin__optimizemember_pro_clickbank_button"))
	{
		/**
		* Shortcode `[optimizeMember-Pro-ClickBank-Button /]`.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_clickbank_button
			{
				/**
				* Shortcode `[optimizeMember-Pro-ClickBank-Button /]`.
				*
				...
				*/
				public static function sc_clickbank_button ($attr = FALSE, $content = FALSE, $shortcode = FALSE)
					{
						return c_ws_plugin__optimizemember_pro_clickbank_button_in::sc_clickbank_button ($attr, $content, $shortcode);
					}
			}
	}
?>