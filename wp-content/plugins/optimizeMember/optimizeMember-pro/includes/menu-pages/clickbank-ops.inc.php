				...
				public function __construct ()
					{
						...
						echo '<p>You\'ll need your IPN v2.1 URL, which is:<br /><code>' . esc_html (site_url ("/?optimizemember_pro_clickbank_notify=1")) . '</code></p>' . "\n";
						echo '<p>Then provide optimizeMember with your Secret Key in the field below.</strong></p>' . "\n";
