        ...
        self.$t.find('.integration_type_select').change(function(e) {
            ...
            switch (integrationType) {
                case 'email':
                    ...
                    show = 'p.email_data_field,div.email_data_field,p.new_window,.form_html_info_field';
                    hide = 'div.field-signup-form-id,div.field-double-optin,p.field-welcome-email,p.form_html_field,div.form_html_field,p.provider_list,p.thank_you_page,p.action_page,div.provider_list_note';
                    break;
                case 'custom':
                case 'oneshoppingcart':
                    hide = 'div.field-signup-form-id,div.field-double-optin,p.field-welcome-email,p.email_data_field,div.email_data_field,p.provider_list,p.thank_you_page,p.action_page,div.provider_list_note,.form_html_info_field';
                    show = 'p.form_html_field,div.form_html_field,p.new_window';
                    break;
                case 'infusionsoft':
                    hide = 'div.field-signup-form-id,div.field-double-optin,p.field-welcome-email,p.email_data_field,p.form_html_field,div.form_html_field,div.email_data_field,p.new_window,p.thank_you_page';
                    show = 'p.provider_list,p.email_html_field,p.name_html_field,div.extra_fields,p.action_page,div.provider_list_note,.form_html_info_field';
                    doIntegrationType(integrationType);
                    break;
                case 'mailchimp':
                    hide = 'div.field-signup-form-id,p.email_data_field,p.form_html_field,div.form_html_field,div.email_data_field,p.new_window,p.action_page,p.email_html_field';
                    show = 'div.field-double-optin,p.provider_list,p.name_html_field,p.thank_you_page,div.extra_fields,div.provider_list_note,.form_html_info_field';
                ...
                case 'ontraport':
                case 'emma':
                    hide = 'div.field-double-optin,p.field-welcome-email,p.form_html_field,div.form_html_field,div.email_data_field,p.new_window,p.action_page,p.email_html_field';
                    show = 'div.field-signup-form-id,p.provider_list,p.name_html_field,p.thank_you_page,div.extra_fields,div.provider_list_note,.form_html_info_field';
                    doIntegrationType(integrationType);
                    break;
            }
