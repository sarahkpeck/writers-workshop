...
<a href="%%wpurl%%/?optimizemember_pro_google_co=1&amp;co[ids]=%%ids%%&amp;co[exp]=%%exp%%&amp;co[desc]=%%desc%%&amp;co[cc]=%%cc%%&amp;co[custom]=%%custom%%&amp;co[ra]=%%ra%%&amp;co[sp]=%%sp%%&amp;co[image]=%%image%%&amp;co[output]=%%output%%">
