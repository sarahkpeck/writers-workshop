...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_ccbill_return_in"))
	{
		/**
		* ccBill Return URL handler ( inner processing routines ).
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_ccbill_return_in
			{
				/**
						...
						if (!empty ($_GET["optimizemember_pro_ccbill_return"]) && $GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["pro_ccbill_client_id"])
							{
								...
								if (!empty /* Using a custom Return URL on success? */ ($_GET["optimizemember_pro_ccbill_return_success"]))
								...
								/**/
								$ccbill["optimizemember_log"][] = /* Log the full Return redirection URL here. */ $rtn_r;
								/**/
