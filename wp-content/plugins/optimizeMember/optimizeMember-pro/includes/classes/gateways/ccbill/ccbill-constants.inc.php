...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_ccbill_constants"))
	{
		/**
		* ccBill API Constants *( for site owners )*.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_ccbill_constants
			{
				/**
				* ccBill API Constants *( for site owners )*.
				*
				...
				public static function ccbill_constants ($c = FALSE, $vars = FALSE)
					{
						...
						* @var bool
						*/
						if (!defined ("OPTIMIZEMEMBER_PRO_CCBILL_GATEWAY"))
							define ("OPTIMIZEMEMBER_PRO_CCBILL_GATEWAY", ($c[] = true));
						/**/
