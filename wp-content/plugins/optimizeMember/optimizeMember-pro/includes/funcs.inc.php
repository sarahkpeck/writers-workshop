<?php
/**
* Loads functions created by optimizeMember Pro.
*
* Copyright: © 2009-2011
...
*/
if (is_dir ($ws_plugin__optimizemember_pro_temp_dir = dirname (__FILE__) . "/functions"))
	foreach (scandir ($ws_plugin__optimizemember_pro_temp_dir) as $ws_plugin__optimizemember_pro_temp_s)
		if (preg_match ("/\.php$/", $ws_plugin__optimizemember_pro_temp_s) && $ws_plugin__optimizemember_pro_temp_s !== "index.php")
