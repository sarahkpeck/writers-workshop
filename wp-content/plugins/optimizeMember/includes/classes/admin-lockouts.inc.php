...
*
* @package optimizeMember\Admin_Lockouts
* @since 3.5
*/
if (realpath (__FILE__) === realpath ($_SERVER["SCRIPT_FILENAME"]))
	exit ("Do not access this file directly.");
/**/
if (!class_exists ("c_ws_plugin__optimizemember_admin_lockouts"))
	{
		/**
		* Locks Users/Members out of admin panels.
		*
		...
		* @since 3.5
		*/
		class c_ws_plugin__optimizemember_admin_lockouts
			{
				/**
				* Locks Users/Members out of admin panels.
				*
				...
				*/
				public static function admin_lockout () /* Prevents admin access. */
					{
						do_action ("ws_plugin__optimizemember_before_admin_lockouts", get_defined_vars ());
						/**/
						if (is_admin () && (!defined ("DOING_AJAX") || !DOING_AJAX) && !current_user_can ("edit_posts") /* Give Filters a chance here too. */)
							if (apply_filters ("ws_plugin__optimizemember_admin_lockout", $GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["force_admin_lockouts"], get_defined_vars ()))
								{
									if ($redirection_url = c_ws_plugin__optimizemember_login_redirects::login_redirection_url ())
									...
									/**/
										...
										wp_redirect (get_page_link ($GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["login_welcome_page"])) . exit ();
								}
						/**/
						do_action ("ws_plugin__optimizemember_after_admin_lockouts", get_defined_vars ());
						/**/
				...
				*/
				public static function filter_admin_menu_bar (&$wp_admin_bar = FALSE)
					{
						do_action ("ws_plugin__optimizemember_before_filter_admin_menu_bar", get_defined_vars ());
						/**/
						...
						if (is_object ($wp_admin_bar) && !current_user_can ("edit_posts") /* If locking Users/Members out of `/wp-admin/` areas. */)
							if (apply_filters ("ws_plugin__optimizemember_admin_lockout", $GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["force_admin_lockouts"], get_defined_vars ()))
								{
									$lwp = c_ws_plugin__optimizemember_login_redirects::login_redirection_url ();
						...
						/**/
						do_action ("ws_plugin__optimizemember_after_filter_admin_menu_bar", get_defined_vars ());
						/**/
						return; /* Return for uniformity. */
					}
			}
