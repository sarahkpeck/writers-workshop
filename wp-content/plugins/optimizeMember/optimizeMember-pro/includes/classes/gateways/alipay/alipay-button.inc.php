...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_alipay_button"))
	{
		/**
		* Shortcode `[optimizeMember-Pro-AliPay-Button /]`.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_alipay_button
			{
				/**
				* Shortcode `[optimizeMember-Pro-AliPay-Button /]`.
				*
				...
				*/
				public static function sc_alipay_button ($attr = FALSE, $content = FALSE, $shortcode = FALSE)
					{
						return c_ws_plugin__optimizemember_pro_alipay_button_in::sc_alipay_button ($attr, $content, $shortcode);
					}
			}
	}
?>