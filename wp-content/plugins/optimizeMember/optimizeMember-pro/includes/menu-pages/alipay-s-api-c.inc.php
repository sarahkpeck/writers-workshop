<?php
/**
* Menu page for optimizeMember Pro ( AliPay API Constants ).
*
* Copyright: © 2009-2011
...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_menu_page_alipay_s_api_c"))
	{
		/**
		* Menu page for optimizeMember Pro ( AliPay API Constants ).
		*
		...
		* @since 110531
		*/
		class c_ws_plugin__optimizemember_pro_menu_page_alipay_s_api_c
			{
...
/**/
new c_ws_plugin__optimizemember_pro_menu_page_alipay_s_api_c ();
?>