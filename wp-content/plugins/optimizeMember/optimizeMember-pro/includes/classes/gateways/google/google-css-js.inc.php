...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_google_css_js"))
	{
		/**
		* Google CSS/JS for theme integration.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_google_css_js
			{
				/**
				...
				*/
				public static function google_js_w_globals ($vars = FALSE)
					{
						$g = "var OPTIMIZEMEMBER_PRO_GOOGLE_GATEWAY = true,";
						/**/
