...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_paypal_constants"))
	{
		/**
		* PayPal API Constants *( for site owners )*.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_paypal_constants
			{
				/**
				* PayPal API Constants *( for site owners )*.
				*
				...
				public static function paypal_constants ($c = FALSE, $vars = FALSE)
					{
						...
						* @var bool
						*/
						if (!defined ("OPTIMIZEMEMBER_PRO_PAYPAL_GATEWAY"))
							define ("OPTIMIZEMEMBER_PRO_PAYPAL_GATEWAY", ($c[] = true));
						/**/
