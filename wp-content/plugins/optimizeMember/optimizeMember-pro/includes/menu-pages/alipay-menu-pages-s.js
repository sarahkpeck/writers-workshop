...
jQuery(document).ready (function($)
	{
		...
		/**/
		if (location.href.match (/page\=ws-plugin--optimizemember-pro-alipay-ops/))
			{
		...
		/**/
		else if (location.href.match (/page\=ws-plugin--optimizemember-pro-alipay-buttons/))
			{
				...
				/**/
				ws_plugin__optimizemember_pro_alipayButtonGenerate = /* Handles AliPay Button Generation. */ function(button)
					{
						var shortCodeTemplate = '[optimizeMember-Pro-AliPay-Button %%attrs%% image="default" output="anchor" /]', shortCodeTemplateAttrs = '', labels = {};
						/**/
						...
						/**/
						shortCodeTemplateAttrs += 'level="' + esc_attr(level) + '" ccaps="' + esc_attr(cCaps) + '" desc="' + esc_attr(desc) + '" custom="<?php echo c_ws_plugin__optimizemember_utils_strings::esc_js_sq (esc_attr ($_SERVER["HTTP_HOST"])); ?>"';
				...
				/**/
				ws_plugin__optimizemember_pro_alipayCcapButtonGenerate = /* Handles AliPay Button Generation. */ function()
					{
						var shortCodeTemplate = '[optimizeMember-Pro-AliPay-Button %%attrs%% image="default" output="anchor" /]', shortCodeTemplateAttrs = '';
						/**/
						...
						/**/
						shortCodeTemplateAttrs += 'level="*" ccaps="' + esc_attr(cCaps) + '" desc="' + esc_attr(desc) + '" custom="<?php echo c_ws_plugin__optimizemember_utils_strings::esc_js_sq (esc_attr ($_SERVER["HTTP_HOST"])); ?>"';
						shortCodeTemplateAttrs += ' ra="' + esc_attr(regAmount) + '" rp="' + esc_attr(regPeriod) + '" rt="' + esc_attr(regTerm) + '"';
						shortCode.val (shortCodeTemplate.replace (/%%attrs%%/, shortCodeTemplateAttrs));
						/**/
				...
				/**/
				ws_plugin__optimizemember_pro_alipaySpButtonGenerate = /* Handles AliPay Button Generation for Specific Post/Page Access. */ function()
					{
						var shortCodeTemplate = '[optimizeMember-Pro-AliPay-Button %%attrs%% image="default" output="anchor" /]', shortCodeTemplateAttrs = '';
						/**/
				...
				/**/
				ws_plugin__optimizemember_pro_alipayRegLinkGenerate = /* Handles AliPay Link Generation. */ function()
					{
				...
				/**/
				ws_plugin__optimizemember_pro_alipaySpLinkGenerate = /* Handles AliPay Link Generation. */ function()
					{
