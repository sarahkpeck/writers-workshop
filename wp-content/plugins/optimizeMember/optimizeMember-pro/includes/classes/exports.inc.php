...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_exports"))
	{
		/**
		* Handles various exportations.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_exports
			{
				/**
				* Handles various exportations.
				*
				...
				*/
				public static function export ()
					{
						if (!empty ($_POST["ws_plugin__optimizemember_pro_export_users"])) /* Call inner routine? */
							{
								return c_ws_plugin__optimizemember_pro_exports_in::export_users ();
							}
						if (!empty ($_GET["ws_plugin__optimizemember_pro_export_ops"])) /* Call routine? */
							{
								return c_ws_plugin__optimizemember_pro_exports_in::export_ops ();
							}
					}
			}
	}
