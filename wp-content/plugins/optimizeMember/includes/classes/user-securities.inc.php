				...
				public static function user_capabilities ($capabilities = FALSE, $caps_map = FALSE, $args = FALSE)
					{
						...
						/**/
						if (!is_multisite () && !empty ($capabilities["administrator"]) && !empty ($args[0]) && preg_match ("/^access_optimizemember_ccap_/i", $args[0]) && apply_filters ("ws_plugin__optimizemember_admins_have_all_ccaps", true, get_defined_vars ()))
