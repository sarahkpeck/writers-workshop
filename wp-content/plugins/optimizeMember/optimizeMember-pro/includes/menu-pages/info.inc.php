<?php
/**
* Menu page for optimizeMember Pro ( Pro Info page ).
*
* Copyright: © 2009-2011
...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_menu_page_info"))
	{
		/**
		* Menu page for optimizeMember Pro ( Pro Info page ).
		*
		...
		* @since 110531
		*/
		class c_ws_plugin__optimizemember_pro_menu_page_info
			{
				public function __construct ()
					{
						...
						echo '<h2>OptimizeMember Pro Module Information</h2>' . "\n";
						/**/
						...
						/**/
						echo '<a href="' . esc_attr (add_query_arg ("c_check_ver", urlencode (c_ws_plugin__optimizemember_pro_readmes::parse_readme_value ("Version")), c_ws_plugin__optimizemember_pro_readmes::parse_readme_value ("Plugin URI"))) . '" target="_blank"><img src="' . esc_attr ($GLOBALS["WS_PLUGIN__"]["optimizemember"]["c"]["dir_url"]) . '/images/brand-updates.png" class="ws-menu-page-brand-updates" alt="." /></a>' . "\n";
						/**/
						echo '<div class="ws-menu-page-readme">' . "\n";
						echo c_ws_plugin__optimizemember_pro_readmes::parse_readme () . "\n";
						echo '</div>' . "\n";
						/**/
						echo '</td>' . "\n";
						/**/
...
/**/
new c_ws_plugin__optimizemember_pro_menu_page_info ();
?>