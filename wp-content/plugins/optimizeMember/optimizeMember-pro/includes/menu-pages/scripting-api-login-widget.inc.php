<?php
/**
* Menu page for optimizeMember Pro ( Scripting, Pro Login Widget ).
*
* Copyright: © 2009-2011
...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_menu_page_scripting_api_login_widget"))
	{
		/**
		* Menu page for optimizeMember Pro ( Scripting, Pro Login Widget ).
		*
		...
		* @since 110531
		*/
		class c_ws_plugin__optimizemember_pro_menu_page_scripting_api_login_widget
			{
...
/**/
new c_ws_plugin__optimizemember_pro_menu_page_scripting_api_login_widget ();
?>