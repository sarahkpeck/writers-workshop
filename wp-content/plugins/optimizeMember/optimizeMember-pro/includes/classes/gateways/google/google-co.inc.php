...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_google_co"))
	{
		/**
		* Google Checkout.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_google_co
			{
				/**
				...
				*/
				public static function google_co ()
					{
						if (!empty ($_GET["optimizemember_pro_google_co"])) /* Call inner routine? */
							{
								return c_ws_plugin__optimizemember_pro_google_co_in::google_co ();
							}
					}
			}
	}
