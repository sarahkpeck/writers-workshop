<?php
/**
* Menu page for optimizeMember Pro ( Unlimited Level Instructions ).
*
* Copyright: © 2009-2011
...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_menu_page_unlimited_level_instructions"))
	{
		/**
		* Menu page for optimizeMember Pro ( Unlimited Level Instructions ).
		*
		...
		* @since 110706
		*/
		class c_ws_plugin__optimizemember_pro_menu_page_unlimited_level_instructions
			{
...
/**/
new c_ws_plugin__optimizemember_pro_menu_page_unlimited_level_instructions ();
?>