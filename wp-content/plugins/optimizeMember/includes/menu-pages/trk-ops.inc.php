<?php
/**
* Menu page for the optimizeMember plugin ( API Tracking page ).
*
* Copyright: © 2009-2011
...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_menu_page_trk_ops"))
	{
		/**
		* Menu page for the optimizeMember plugin ( API Tracking page ).
		*
		...
		* @since 110531
		*/
		class c_ws_plugin__optimizemember_menu_page_trk_ops
			{
...
/**/
new c_ws_plugin__optimizemember_menu_page_trk_ops ();
?>