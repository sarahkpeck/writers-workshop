...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_alipay_constants"))
	{
		/**
		* AliPay API Constants *( for site owners )*.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_alipay_constants
			{
				/**
				* AliPay API Constants *( for site owners )*.
				*
				...
				public static function alipay_constants ($c = FALSE, $vars = FALSE)
					{
						...
						* @var bool
						*/
						if (!defined ("OPTIMIZEMEMBER_PRO_ALIPAY_GATEWAY"))
							define ("OPTIMIZEMEMBER_PRO_ALIPAY_GATEWAY", ($c[] = true));
						/**/
