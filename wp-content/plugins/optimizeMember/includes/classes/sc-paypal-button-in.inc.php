				...
				public static function sc_paypal_button ($attr = FALSE, $content = FALSE, $shortcode = FALSE)
					{
						...
						if /* Cancellation Buttons. */ ($attr["cancel"])
						...
						else if /* Specific Post/Page Buttons. */ ($attr["sp"])
							{
								...
								/**/
								$success_return_url = /* optimizeMember handles this all by itself. However, it can be Filtered. */ site_url ("/?optimizemember_paypal_return=1");
						...
						else /* Otherwise, we'll process this Button normally, using Membership routines. */
							{
								...
								/**/
								$success_return_url = /* optimizeMember handles this all by itself. However, it can be Filtered ( see below ). */ site_url ("/?optimizemember_paypal_return=1");
