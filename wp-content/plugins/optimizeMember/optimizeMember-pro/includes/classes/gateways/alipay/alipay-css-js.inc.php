...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_alipay_css_js"))
	{
		/**
		* AliPay CSS/JS for theme integration.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_alipay_css_js
			{
				/**
				...
				*/
				public static function alipay_js_w_globals ($vars = FALSE)
					{
						$g = "var OPTIMIZEMEMBER_PRO_ALIPAY_GATEWAY = true,";
						/**/
