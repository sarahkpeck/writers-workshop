...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_paypal_css_js"))
	{
		/**
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_paypal_css_js
			{
				/**
				...
				*/
				public static function paypal_js_w_globals ($vars = FALSE)
					{
						$g = "var OPTIMIZEMEMBER_PRO_PAYPAL_GATEWAY = true,";
						/**/
