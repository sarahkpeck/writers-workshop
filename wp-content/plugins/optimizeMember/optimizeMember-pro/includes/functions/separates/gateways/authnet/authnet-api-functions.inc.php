...
* Example usage: ``if(optimizemember_pro_authnet_s2p_v_query_ok($_SERVER["QUERY_STRING"])){ }``
*
* @package optimizeMember\API_Functions
* @since 1.5
*
...
*/
if (!function_exists ("optimizemember_pro_authnet_s2p_v_query_ok"))
	{
		function optimizemember_pro_authnet_s2p_v_query_ok ($url_uri_query = FALSE, $ignore_time = FALSE, $exp_secs = FALSE)
			{
