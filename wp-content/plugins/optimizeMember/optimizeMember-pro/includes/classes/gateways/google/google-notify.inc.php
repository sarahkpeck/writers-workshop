...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_google_notify"))
	{
		/**
		* Google IPN Handler.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_google_notify
			{
				/**
				...
				*/
				public static function google_notify ()
					{
						if (!empty ($_GET["optimizemember_pro_google_notify"])) /* Call inner routine? */
							{
								return c_ws_plugin__optimizemember_pro_google_notify_in::google_notify ();
							}
					}
			}
	}
