...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_ccbill_button"))
	{
		/**
		* Shortcode `[optimizeMember-Pro-ccBill-Button /]`.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_ccbill_button
			{
				/**
				* Shortcode `[optimizeMember-Pro-ccBill-Button /]`.
				*
				...
				*/
				public static function sc_ccbill_button ($attr = FALSE, $content = FALSE, $shortcode = FALSE)
					{
						return c_ws_plugin__optimizemember_pro_ccbill_button_in::sc_ccbill_button ($attr, $content, $shortcode);
					}
			}
	}
?>