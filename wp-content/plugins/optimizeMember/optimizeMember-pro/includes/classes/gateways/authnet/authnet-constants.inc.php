...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_authnet_constants"))
	{
		/**
		* Authorize.Net API Constants *( for site owners )*.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_authnet_constants
			{
				/**
				* Authorize.Net API Constants *( for site owners )*.
				*
				...
				public static function authnet_constants ($c = FALSE, $vars = FALSE)
					{
						...
						* @var bool
						*/
						if (!defined ("OPTIMIZEMEMBER_PRO_AUTHNET_GATEWAY"))
							define ("OPTIMIZEMEMBER_PRO_AUTHNET_GATEWAY", ($c[] = true));
						/**/
