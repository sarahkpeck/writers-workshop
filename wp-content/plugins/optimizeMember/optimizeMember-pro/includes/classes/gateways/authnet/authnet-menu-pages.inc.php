...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_authnet_menu_pages"))
	{
		/**
		* Authorize.Net Menu Pages.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_authnet_menu_pages
			{
				/**
				...
				public static function authnet_admin_options ($add_divider = TRUE, $vars = FALSE)
					{
						...
						add_submenu_page ($vars["menu"], "optimizeMember Pro / Authorize.Net Options", "Auth.Net Options", "create_users", "ws-plugin--optimizemember-pro-authnet-ops", "c_ws_plugin__optimizemember_pro_authnet_menu_pages::authnet_ops_page");
						add_submenu_page ($vars["menu"], "optimizeMember Pro / Authorize.Net Pro Forms", "Auth.Net Pro-Forms", "create_users", "ws-plugin--optimizemember-pro-authnet-forms", "c_ws_plugin__optimizemember_pro_authnet_menu_pages::authnet_forms_page");
						/**/
				...
				*/
				public static function authnet_forms_page ()
					{
						if (c_ws_plugin__optimizemember_pro_authnet_responses::authnet_form_api_validation_errors ()) /* Report error if Authorize.Net Options are not yet configured. */
