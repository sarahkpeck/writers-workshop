...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_ccbill_notify_in"))
	{
		/**
		* ccBill IPN Handler ( inner processing routines ).
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_ccbill_notify_in
			{
				/**
						...
						if (isset ($_GET["optimizemember_pro_ccbill_notify"]) && strlen ($_GET["optimizemember_pro_ccbill_notify"]) && $GLOBALS["WS_PLUGIN__"]["optimizemember"]["o"]["pro_ccbill_client_id"])
							{
								...
								if (is_array ($ccbill = c_ws_plugin__optimizemember_pro_ccbill_utilities::ccbill_postvars ()) && ($_ccbill = $ccbill))
								...
								else /* Extensive log reporting here. This is an area where many site owners find trouble. Depending on server configuration; remote HTTPS connections may fail. */
									{
										...
										$ccbill["optimizemember_log"][] = var_export ($_REQUEST, true); /* Recording _POST + _GET vars for analysis and debugging. */
									}
								/*
