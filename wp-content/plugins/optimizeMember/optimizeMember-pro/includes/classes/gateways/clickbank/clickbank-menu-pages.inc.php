...
if (!class_exists ("c_ws_plugin__optimizemember_pro_clickbank_menu_pages"))
	{
		/**
		* ClickBank® Menu Pages.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_clickbank_menu_pages
			{
				/**
				...
				public static function clickbank_admin_options ($add_divider = TRUE, $vars = FALSE)
					{
						...
						add_submenu_page ($vars["menu"], "optimizeMember Pro / ClickBank® Options", "ClickBank® Options", "create_users", "ws-plugin--optimizemember-pro-clickbank-ops", "c_ws_plugin__optimizemember_pro_clickbank_menu_pages::clickbank_ops_page");
						add_submenu_page ($vars["menu"], "optimizeMember Pro / ClickBank® Buttons", "ClickBank® Buttons", "create_users", "ws-plugin--optimizemember-pro-clickbank-buttons", "c_ws_plugin__optimizemember_pro_clickbank_menu_pages::clickbank_buttons_page");
