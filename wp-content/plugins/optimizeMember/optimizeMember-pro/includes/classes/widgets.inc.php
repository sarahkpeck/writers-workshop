...
/**/
if (!class_exists ("c_ws_plugin__optimizemember_pro_widgets"))
	{
		/**
		* optimizeMember Pro Widgets.
		*
		...
		* @since 1.5
		*/
		class c_ws_plugin__optimizemember_pro_widgets
			{
				/**
				* Registers Widgets.
				*
				...
				*/
				public static function login_widget_register ()
					{
						do_action ("ws_plugin__optimizemember_pro_login_widget_before_register", get_defined_vars ());
						/**/
						register_widget("c_ws_plugin__optimizemember_pro_login_widget");
						/**/
						do_action ("ws_plugin__optimizemember_pro_login_widget_after_register", get_defined_vars ());
						/**/
